...
In the second step we keep r<sub>ij</sub> fixed and we minimize the objective function with respect to <img src="https://render.githubusercontent.com/render/math?math=\mu_k".
<p align = "center">
